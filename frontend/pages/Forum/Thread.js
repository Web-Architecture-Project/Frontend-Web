...
const Thread = ({ threadId, react, customStyle }) => {
    ...
    if (thread !== undefined) {
        return (
            <List.Item
                ...
                style={customStyle ? customStyle : { backgroundColor: "#f5f5f5", marginBottom: "20px", border: "solid", borderColor: "#1890ff", borderRadius: "20px" }}
            >
                <List.Item.Meta
